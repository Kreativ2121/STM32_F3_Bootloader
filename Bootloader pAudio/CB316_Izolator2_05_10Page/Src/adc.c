...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOB, aCurHOT_ADC1_IN11_Pin|aCurCOLD_ADC1_IN12_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB15     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(aVBRA_ADC2_IN2_GPIO_Port, aVBRA_ADC2_IN2_Pin);

    HAL_GPIO_DeInit(GPIOB, aVBRB_ADC2_14_Pin|aSens_swSens_ADC2_IN15_Pin);
